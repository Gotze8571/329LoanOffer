    ...
    public class RemittaController : Controller
    {
        ...
        public ActionResult Index(int? page, string search)
        {
            ...
            try
            {
                ...
                if (phoneNo != null)
                {
                    var result = dataConnector.GetRemittaLoanDb(startDate, endDate, phoneNo).ToPagedList(pageNumber, pageSize);
        ...
        public FileContentResult ExportToExcel(int? page, string RequestTime, string LogTime)
        {
            ...
            if (RequestTime != null)
            {
                ...
                list = report.GetRemittaLoanDb(RequestTime, LogTime, PhoneNo);
